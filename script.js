...
const SYSTEMS = {
  ...
  projects: {
    ...
    planets:[
      { name:'Sudoku Solver', color:0x8899aa, radius:2.8, orbitR:30, orbitSpeed:0.50, startAngle:0,
      ...
      { name:'Portfolio', color:0x2255bb, radius:2.5, orbitR:46, orbitSpeed:0.36, startAngle:Math.PI*0.4,
      ...
      { name:'H.A.D.E.S.', color:0xcc3322, radius:3.0, orbitR:62, orbitSpeed:0.27, startAngle:Math.PI*0.9,
      ...
      { name:'Argus', color:0xccaa22, radius:3.8, orbitR:79, orbitSpeed:0.21, startAngle:Math.PI*1.5, hasRings:true, ringColor:0xddcc66,
      ...
      { name:'Animal Encyclopedia', color:0x33aa55, radius:2.5, orbitR:97, orbitSpeed:0.16, startAngle:Math.PI*0.2,
  ...
  contact: {
    ...
    planets:[
      { name:'Email', color:0xff4422, radius:3.2, orbitR:28, orbitSpeed:0.42, startAngle:Math.PI*0.3,
      ...
      { name:'GitHub', color:0x889999, radius:3.0, orbitR:46, orbitSpeed:0.30, startAngle:Math.PI*1.1,
        content:{ type:'link', heading:'GitHub', value:'ShubhamMohta29',
          url:'https://github.com/ShubhamMohta29', btnLabel:'View profile →' }},
      { name:'LinkedIn', color:0x1155cc, radius:3.4, orbitR:65, orbitSpeed:0.22, startAngle:Math.PI*1.8, hasRings:true, ringColor:0x3377ff,
  ...
  resume: {
    ...
    planets:[
      { name:'Education', color:0x44aadd, radius:3.5, orbitR:28, orbitSpeed:0.40, startAngle:Math.PI*0.2,
        content:{ type:'info', heading:'Education',
          body:"University of Toronto\nB.Sc. Computer Science & Astrophysics · Math Minor\n2023 – present" }},
      { name:'Skills', color:0x22cc88, radius:3.0, orbitR:47, orbitSpeed:0.29, startAngle:Math.PI*1.0,
      ...
      { name:'View Résumé', color:0xddaa22, radius:2.8, orbitR:65, orbitSpeed:0.21, startAngle:Math.PI*1.6,
